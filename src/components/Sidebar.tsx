...
import {
  ...
  Bell, CalendarClock, FileOutput, Upload, Compass, Camera,
...
const sections: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { key: 'receipt-scan', label: 'Mobile Scanner', friendlyLabel: 'Scan Receipts', icon: <Camera size={18} /> },
      ...
      { key: 'fintech-hub', label: 'FinTech Hub', friendlyLabel: 'FinTech APIs', icon: <Radio size={18} /> },
