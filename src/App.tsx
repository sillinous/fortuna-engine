...
function AppInner() {
  ...
  const renderView = useCallback(() => {
    switch (activeView) {
      ...
      case 'fin-statements': return <FinancialStatementsWizard />
